...
import { Alert, BackHandler, Image, Linking, Modal, Platform, Pressable, StyleSheet, Switch, Text, View } from 'react-native';
...
export default function HomeScreen() {
  ...
  const { status, accessRemainingSeconds, isAccessExpired, servers, tweaks, selectedServerId, selectedProfileId, fastestStatus, fastestMessage, settings, configVersion, selectServer, selectProfile, toggleSetting, clearAppData, requestConnection, disconnect, updateConfig } = useAppState();

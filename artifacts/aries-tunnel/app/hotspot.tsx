...
export default function HotspotScreen() {
  ...
  return <Screen>
    ...
    <Surface style={styles.detailsCard}><Pressable onPress={() => { void copy(proxy, 'Hostname'); }} style={styles.detailLine}><Text style={[styles.detailLabel, { color: colors.foreground }]}>Hostname:</Text><Text style={[styles.detailValue, { color: colors.primary }]}>{proxy}</Text></Pressable><Pressable onPress={() => { void copy(port, 'Proxy Port'); }} style={styles.detailLine}><Text style={[styles.detailLabel, { color: colors.foreground }]}>Proxy Port:</Text><Text style={[styles.detailValue, { color: colors.primary }]}>{port}</Text></Pressable></Surface>
